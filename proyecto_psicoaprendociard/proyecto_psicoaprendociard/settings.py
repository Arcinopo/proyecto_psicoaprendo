...
SECRET_KEY = 'django-insecure-=nds!4otlaw@fvz4w9zn%uh-*3b+x+0h6=9ulw5s!^)uoeakc6'
...
ROOT_URLCONF = 'proyecto_psicoaprendociard.urls'
...
WSGI_APPLICATION = 'proyecto_psicoaprendociard.wsgi.application'
